...
CREATE TABLE FATO_VENDA_LOJA_MENSAL (
	...
	CONSTRAINT FK_DIM_LOJA_FATO_VENDA_LOJA_MENSAL FOREIGN KEY (ID_LOJA) REFERENCES DIM_LOJA (ID_LOJA),
	CONSTRAINT FK_TEMPO_FATO_VENDA_LOJA_MENSAL FOREIGN KEY (ID_TEMPO) REFERENCES DIM_TEMPO (ID_TEMPO),
)
