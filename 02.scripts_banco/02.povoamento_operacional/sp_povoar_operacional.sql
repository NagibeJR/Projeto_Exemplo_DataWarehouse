...
/*
   ...
   criados um loop para cada categoria de produto, uma
...
begin
    ...
    declare @cod_loja int,
	 ...
	 insert into #tb_volume_max values('GASOLINA',50)
	 insert into #tb_volume_max values('ETANOL',50)
	 insert into #tb_volume_max values('DIESEL',50)
	 ...
	 values(@cod_loja, @cod_produto, @cod_tipo_pagamento,
	        @data, @volume, @valor)
end
